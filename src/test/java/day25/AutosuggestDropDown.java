...
public class AutosuggestDropDown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//textarea[contains(@class,'gLFyf')]")).sendKeys("selenium");
		Thread.sleep(3000);
		/*
		...
		// print all the auto suggestions in the console window
		/*
		...
		*/
		...
		// select the auto suggestions from the list
		/*
		for(WebElement list:auto_suggestions)
		{
		...
		// select the one of the auto suggestions from the list
